 ...
 */
const I = globalThis, q = I.ShadowRoot && (I.ShadyCSS === void 0 || I.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, H = Symbol(), L = /* @__PURE__ */ new WeakMap();
let Y = class {
  constructor(e, t, o) {
    if (this._$cssResult$ = !0, o !== H) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (q && e === void 0) {
      ...
      o && (e = L.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), o && L.set(t, e));
    }
    return e;
  }
  toString() {
...
const O = (r) => new Y(typeof r == "string" ? r : r + "", void 0, H), ee = (r, ...e) => {
...
}, B = q ? (r) => r : (r) => r instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: le, defineProperty: pe, getOwnPropertyDescriptor: he, getOwnPropertyNames: me, getOwnPropertySymbols: ce, getPrototypeOf: de } = Object, D = globalThis, W = D.trustedTypes, ge = W ? W.emptyScript : "", we = D.reactiveElementPolyfillSupport, A = (r, e) => r, T = { toAttribute(r, e) {
  switch (e) {
    case Boolean:
      r = r ? ge : null;
      break;
  ...
  return t;
} }, te = (r, e) => !le(r, e), V = { attribute: !0, type: String, converter: T, reflect: !1, useDefault: !1, hasChanged: te };
...
let x = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, o) {
    const { get: s, set: n } = he(this.prototype, e) ?? { get() {
      return this[t];
    }, set(i) {
      this[t] = i;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(A("properties"))) {
      const t = this.properties, o = [...me(t), ...ce(t)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const s of o) t.unshift(B(s));
  ...
  _$ET(e, t) {
    ...
    if (s !== void 0 && o.reflect === !0) {
      const n = (o.converter?.toAttribute !== void 0 ? o.converter : T).toAttribute(t, o.type);
  ...
  _$AK(e, t) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const n = o.getPropertyOptions(s), i = typeof n.converter == "function" ? { fromAttribute: n.converter } : n.converter?.fromAttribute !== void 0 ? n.converter : T;
      this._$Em = s, this[s] = i.fromAttribute(t, n.type) ?? this._$Ej?.get(s) ?? null, this._$Em = null;
    }
  }
  requestUpdate(e, t, o) {
    if (e !== void 0) {
      const s = this.constructor, n = this[e];
      if (o ??= s.getPropertyOptions(e), !((o.hasChanged ?? te)(n, t) || o.useDefault && o.reflect && n === this._$Ej?.get(e) && !this.hasAttribute(s._$Eu(e, o)))) return;
      this.C(e, t, o);
    }
    this.isUpdatePending === !1 && (this._$ES = this._$EP());
  }
  C(e, t, { useDefault: o, reflect: s, wrapped: n }, i) {
    o && !(this._$Ej ??= /* @__PURE__ */ new Map()).has(e) && (this._$Ej.set(e, i ?? t ?? this[e]), n !== !0 || i !== void 0) || (this._$AL.has(e) || (this.hasUpdated || o || (t = void 0), this._$AL.set(e, t)), s === !0 && this._$Em !== e && (this._$Eq ??= /* @__PURE__ */ new Set()).add(e));
  }
  async _$EP() {
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (o.size > 0) for (const [s, n] of o) {
        const { wrapped: i } = n, m = this[s];
        i !== !0 || this._$AL.has(s) || m === void 0 || this.C(s, void 0, n, m);
      }
    }
    let e = !1;
    const t = this._$AL;
...
x.elementStyles = [], x.shadowRootOptions = { mode: "open" }, x[A("elementProperties")] = /* @__PURE__ */ new Map(), x[A("finalized")] = /* @__PURE__ */ new Map(), we?.({ ReactiveElement: x }), (D.reactiveElementVersions ??= []).push("2.1.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const R = globalThis, P = R.trustedTypes, Z = P ? P.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, oe = "$lit$", b = `lit$${Math.random().toFixed(9).slice(2)}$`, se = "?" + b, be = `<${se}>`, v = document, C = () => v.createComment(""), k = (r) => r === null || typeof r != "object" && typeof r != "function", j = Array.isArray, ue = (r) => j(r) || typeof r?.[Symbol.iterator] == "function", M = `[ 	
\f\r]`, z = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, G = /-->/g, J = />/g, u = RegExp(`>|${M}(?:([^\\s"'>=/]+)(${M}*=${M}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), K = /'/g, Q = /"/g, re = /^(?:script|style|textarea|title)$/i, fe = (r) => (e, ...t) => ({ _$litType$: r, strings: e, values: t }), d = fe(1), $ = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), X = /* @__PURE__ */ new WeakMap(), f = v.createTreeWalker(v, 129);
function ne(r, e) {
...
const ve = (r, e) => {
  ...
  let s, n = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", i = z;
  for (let m = 0; m < t; m++) {
    const a = r[m];
    let p, c, l = -1, g = 0;
    for (; g < a.length && (i.lastIndex = g, c = i.exec(a), c !== null); ) g = i.lastIndex, i === z ? c[1] === "!--" ? i = G : c[1] !== void 0 ? i = J : c[2] !== void 0 ? (re.test(c[2]) && (s = RegExp("</" + c[2], "g")), i = u) : c[3] !== void 0 && (i = u) : i === u ? c[0] === ">" ? (i = s ?? z, l = -1) : c[1] === void 0 ? l = -2 : (l = i.lastIndex - c[2].length, p = c[1], i = c[3] === void 0 ? u : c[3] === '"' ? Q : K) : i === Q || i === K ? i = u : i === G || i === J ? i = z : (i = u, s = void 0);
    const w = i === u && r[m + 1].startsWith("/>") ? " " : "";
    n += i === z ? a + be : l >= 0 ? (o.push(p), a.slice(0, l) + oe + a.slice(l) + b + w) : a + b + (l === -2 ? m : w);
  }
  return [ne(r, n + (r[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), o];
};
class S {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    this.parts = [];
    let n = 0, i = 0;
    const m = e.length - 1, a = this.parts, [p, c] = ve(e, t);
    if (this.el = S.createElement(p, o), f.currentNode = this.el.content, t === 2 || t === 3) {
      const l = this.el.content.firstChild;
      l.replaceWith(...l.childNodes);
    }
    for (; (s = f.nextNode()) !== null && a.length < m; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const l of s.getAttributeNames()) if (l.endsWith(oe)) {
          const g = c[i++], w = s.getAttribute(l).split(b), U = /([.?@])?(.*)/.exec(g);
          a.push({ type: 1, index: n, name: U[2], strings: w, ctor: U[1] === "." ? ye : U[1] === "?" ? $e : U[1] === "@" ? _e : F }), s.removeAttribute(l);
        } else l.startsWith(b) && (a.push({ type: 6, index: n }), s.removeAttribute(l));
        if (re.test(s.tagName)) {
          const l = s.textContent.split(b), g = l.length - 1;
          if (g > 0) {
            s.textContent = P ? P.emptyScript : "";
            for (let w = 0; w < g; w++) s.append(l[w], C()), f.nextNode(), a.push({ type: 2, index: ++n });
            s.append(l[g], C());
          }
        }
      } else if (s.nodeType === 8) if (s.data === se) a.push({ type: 2, index: n });
      else {
        let l = -1;
        for (; (l = s.data.indexOf(b, l + 1)) !== -1; ) a.push({ type: 7, index: n }), l += b.length - 1;
      }
      n++;
    }
  }
...
function _(r, e, t = r, o) {
  ...
  return s?.constructor !== n && (s?._$AO?.(!1), n === void 0 ? s = void 0 : (s = new n(r), s._$AT(r, t, o)), o !== void 0 ? (t._$Co ??= [])[o] = s : t._$Cl = s), s !== void 0 && (e = _(r, s._$AS(r, e.values), s, o)), e;
}
class xe {
  constructor(e, t) {
  ...
  u(e) {
    ...
    for (; a !== void 0; ) {
      if (i === a.index) {
        let p;
        a.type === 2 ? p = new E(n, n.nextSibling, this, e) : a.type === 1 ? p = new a.ctor(n, a.name, a.strings, this, e) : a.type === 6 && (p = new ze(n, this, e)), this._$AV.push(p), a = o[++m];
      }
...
class E {
  ...
  _$AI(e, t = this) {
    e = _(this, e, t), k(e) ? e === h || e == null || e === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : e !== this._$AH && e !== $ && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : ue(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== h && k(this._$AH) ? this._$AA.nextSibling.data = e : this.T(v.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    const { values: t, _$litType$: o } = e, s = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = S.createElement(ne(o.h, o.h[0]), this.options)), o);
    if (this._$AH?._$AD === s) this._$AH.p(t);
    else {
      const n = new xe(s, this), i = n.u(this.options);
      n.p(t), this.T(i), this._$AH = n;
    }
  }
  _$AC(e) {
    let t = X.get(e.strings);
    return t === void 0 && X.set(e.strings, t = new S(e)), t;
  }
  k(e) {
    j(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let o, s = 0;
    for (const n of e) s === t.length ? t.push(o = new E(this.O(C()), this.O(C()), this, this.options)) : o = t[s], o._$AI(n), s++;
...
class F {
  ...
  _$AI(e, t = this, o, s) {
    ...
    let i = !1;
    if (n === void 0) e = _(this, e, t, 0), i = !k(e) || e !== this._$AH && e !== $, i && (this._$AH = e);
    else {
      const m = e;
      let a, p;
      for (e = n[0], a = 0; a < n.length - 1; a++) p = _(this, m[o + a], t, a), p === $ && (p = this._$AH[a]), i ||= !k(p) || p !== this._$AH[a], p === h ? e = h : e !== h && (e += (p ?? "") + n[a + 1]), this._$AH[a] = p;
    }
    i && !s && this.j(e);
  }
  j(e) {
...
Ae?.(S, E), (R.litHtmlVersions ??= []).push("3.3.0");
const Ce = (r, e, t) => {
...
customElements.define("consent-wall", Se);
class Ee extends y {
  static styles = [
    O(ie),
    ee`
...
customElements.define("media-encoding-status", Ee);
export {
  Se as ConsentWall,
  Ee as MediaEncodingStatus
};
