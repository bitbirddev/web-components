 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const N = globalThis, P = N.trustedTypes, W = P ? P.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, ee = "$lit$", b = `lit$${(Math.random() + "").slice(9)}$`, oe = "?" + b, we = `<${oe}>`, v = document, k = () => v.createComment(""), C = (r) => r === null || typeof r != "object" && typeof r != "function", te = Array.isArray, be = (r) => te(r) || typeof r?.[Symbol.iterator] == "function", T = `[ 	
...
class E {
  ...
  _$AI(e, o = this) {
    e = _(this, e, o), C(e) ? e === h || e == null || e === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : e !== this._$AH && e !== $ && this._(e) : e._$litType$ !== void 0 ? this.g(e) : e.nodeType !== void 0 ? this.$(e) : be(e) ? this.T(e) : this._(e);
  }
  k(e) {
  ...
  T(e) {
    ...
    let t, s = 0;
    for (const n of e)
      s === o.length ? o.push(t = new E(this.k(k()), this.k(k()), this, this.options)) : t = o[s], t._$AI(n), s++;
...
class F {
  ...
  _$AI(e, o = this, t, s) {
    ...
    let i = !1;
    if (n === void 0)
      e = _(this, e, o, 0), i = !C(e) || e !== this._$AH && e !== $, i && (this._$AH = e);
    else {
      const m = e;
      let a, p;
      for (e = n[0], a = 0; a < n.length - 1; a++)
        p = _(this, m[t + a], o, a), p === $ && (p = this._$AH[a]), i ||= !C(p) || p !== this._$AH[a], p === h ? e = h : e !== h && (e += (p ?? "") + n[a + 1]), this._$AH[a] = p;
    }
    i && !s && this.O(e);
  }
  O(e) {
...
const ze = (r, e, o) => {
  ...
  if (s === void 0) {
    ...
    t._$litPart$ = s = new E(e.insertBefore(k(), n), n, void 0, o ?? {});
  }
  return s._$AI(r), s;
};
/**
