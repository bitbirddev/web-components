...
class B {
  ...
  _$AI(e, r = this) {
    e = k(this, e, r), G(e) ? e === w || e == null || e === "" ? (this._$AH !== w && this._$AR(), this._$AH = w) : e !== this._$AH && e !== P && this._(e) : e._$litType$ !== void 0 ? this.g(e) : e.nodeType !== void 0 ? this.$(e) : pr(e) ? this.T(e) : this._(e);
  }
  k(e) {
...
class oe {
  ...
  _$AI(e, r = this, s, o) {
    ...
    let a = !1;
    if (n === void 0)
      e = k(this, e, r, 0), a = !G(e) || e !== this._$AH && e !== P, a && (this._$AH = e);
    else {
      const l = e;
      let i, p;
      for (e = n[0], i = 0; i < n.length - 1; i++)
        p = k(this, l[s + i], r, i), p === P && (p = this._$AH[i]), a ||= !G(p) || p !== this._$AH[i], p === w ? e = w : e !== w && (e += (p ?? "") + n[i + 1]), this._$AH[i] = p;
    }
    a && !o && this.O(e);
  }
  O(e) {
...
var Lt = On, Mn = jt, Dn = In, Un = ae, jn = Lt, Fn = /[\\^$.*+?()[\]{}|]/g, Ln = /^\[object .+?Constructor\]$/, Rn = Function.prototype, Nn = Object.prototype, Hn = Rn.toString, Gn = Nn.hasOwnProperty, qn = RegExp(
...
var Ui = Di, tt = ne, rt = ki, ji = ze, Fi = Nt, Li = Mi, Ri = Ui, Ni = 1, Hi = 2, Gi = "[object Boolean]", qi = "[object Date]", Bi = "[object Error]", Ki = "[object Map]", Wi = "[object Number]", Zi = "[object RegExp]", Ji = "[object Set]", Vi = "[object String]", Xi = "[object Symbol]", Yi = "[object ArrayBuffer]", Qi = "[object DataView]", st = tt ? tt.prototype : void 0, we = st ? st.valueOf : void 0;
...
var El = Sl, Tl = M, zl = y, Il = Tl(zl, "DataView"), Pl = Il, kl = M, Ol = y, Ml = kl(Ol, "Promise"), Dl = Ml, Ul = M, jl = y, Fl = Ul(jl, "Set"), Ll = Fl, Rl = M, Nl = y, Hl = Rl(Nl, "WeakMap"), Gl = Hl, be = Pl, ve = Ie, ye = Dl, $e = Ll, _e = Gl, Ht = K, F = Lt, at = "[object Map]", ql = "[object Object]", it = "[object Promise]", lt = "[object Set]", pt = "[object WeakMap]", ct = "[object DataView]", Bl = F(be), Kl = F(ve), Wl = F(ye), Zl = F($e), Jl = F(_e), S = Ht;
...
var Zt = qp, bt = ne, Bp = Zt, Kp = v, Wp = ke, Zp = 1 / 0, vt = bt ? bt.prototype : void 0, yt = vt ? vt.toString : void 0;
function Jt(t) {
  if (typeof t == "string")
    return t;
  if (Kp(t))
...
var Yp = Xp, Qp = v, ec = Oe, tc = Gp, rc = Yp;
function sc(t, e) {
...
var Sc = Cc, Ec = qt, Tc = mc, zc = Sc, Ic = Oe, Pc = Bt, kc = Kt, Oc = me, Mc = 1, Dc = 2;
function Uc(t, e) {
...
var qc = Gc, Bc = Nc, Kc = qc, Wc = Oe, Zc = me;
function Jc(t) {
...
class zh extends I {
  ...
  connectedCallback() {
    super.connectedCallback(), this.requiredConsents.length > 0 && (console.log("adding listener"), window.addEventListener("UC_UI_INITIALIZED", (e) => {
